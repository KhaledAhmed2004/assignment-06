...
const Post = ({ post }: any) => {
  ...
  return (
    <div className="p-6 bg-gradient-to-br from-white via-gray-50 to-gray-100 dark:from-gray-800 dark:via-gray-700 dark:to-gray-900 shadow-lg rounded-3xl mb-8 transition-transform duration-300 transform">
      ...
      >
        {/* Title */}
        <h2 className="text-2xl md:text-3xl font-extrabold text-gray-800 dark:text-white mb-3 hover:text-blue-600 dark:hover:text-blue-400 transition duration-300">
          {post?.title}
        </h2>
        ...
        <div className="mt-4 rounded-lg overflow-hidden relative shadow-md transition-transform duration-300 transform hover:shadow-xl">
          <Image
            className="w-full h-64 md:h-80 object-cover transition-transform duration-300 transform hover:scale-105"
            src={post?.images[0]}
            alt="Post image"
            width={500}
            height={300}
