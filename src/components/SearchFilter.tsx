...
// //           {categories?.map(
// //             (
// //               categoryItem: CategoryItem // Specify type here
// //             ) => (
// //               <button
      ...
      <div className="flex justify-center space-x-4 mb-4">
        <button
          ...
          className={`px-4 py-2 rounded-full text-sm font-medium ${
            sortOrder === "upvotes" ? "bg-blue-200 text-blue-500" :
            sortOrder === "-upvotes" ? "bg-blue-500 text-white" : "bg-gray-200 dark:bg-gray-600 dark:text-gray-300"
          }`}
        >
          Sort by Upvotes
        </button>
        <button
          ...
          className={`px-4 py-2 rounded-full text-sm font-medium ${
            sortOrder === "downvotes" ? "bg-blue-200 text-blue-500" :
            sortOrder === "-downvotes" ? "bg-blue-500 text-white" : "bg-gray-200 dark:bg-gray-600 dark:text-gray-300"
          }`}
        >
          Sort by Downvotes
        </button>
      ...
      <div className="relative flex items-center justify-center">
        ...
        >
          <button
            onClick={() => handleCategorySelect("all")}
            className={`px-4 py-2 whitespace-nowrap rounded-full text-sm font-medium border ${
              category === "all" ? "bg-blue-200 text-blue-500" : "bg-gray-200 dark:bg-gray-600 dark:text-gray-300"
            }`}
          >
            All
          </button>
